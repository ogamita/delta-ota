...
e2e: e2e-install e2e-auth e2e-ops e2e-recovery e2e-parallel e2e-two-process e2e-resume e2e-admin-identity e2e-client-state e2e-stats e2e-lazy-upgrade e2e-notifications
e2e-install:
	tests/e2e/run.sh
e2e-auth:
	tests/e2e/auth.sh
